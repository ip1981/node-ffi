...
/**
 * Returns a `Type` object for the given 'type' name.
 */

ffi.getType = function getType (type) {
  return ffi.Type[type] || type
}
...
function isStructType (type) {
  return type && type.__isStructType__
}
